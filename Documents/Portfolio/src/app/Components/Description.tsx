...
const Accordion = ({ title, content }: { title: string; content: string }) => {
  ...
  return (
    <div className="border-b border-pink-400">
      ...
      >
        <p className="py-2 bg-gradient-to-r from-pink-500 to-blue-500 bg-clip-text text-transparent">
          {content}
        </p>
      </motion.div>
    </div>
  ...
  return (
    <div className="max-w-lg mx-auto mt-10 space-y-4  text-justify">
      ...
      <Accordion
        ...
        content="Conception d’API sécurisées avec Node.js et Express, gestion des bases de données relationnelles avec PostgreSQL."
      />
      <Accordion
        title="Gestion de Projets"
        content="Planification et suivi de projets avec ProjectLibre, gestion des tâches et des délais, et communication efficace avec les parties prenantes."
      />
      <Accordion
        title="Méthodologies de Travail & Collaboration"
        content="Utilisation des méthodes Agile (Scrum, Kanban), conception de cahier des charges, gestion du versioning avec Git & GitHub, travail seule ou en équipe / pair-programming et communication efficace via Discord"
      />
      <Accordion
